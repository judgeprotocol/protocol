...
| [The Judge Protocol (TJP) v0.96](https://github.com/judgeprotocol/protocol/blob/main/judge_protocol_v0_96.pdf) | Full framework — governance structure, decision gate, hardware enforcement, domain rules, funding model | [10.5281/zenodo.20425548](https://doi.org/10.5281/zenodo.20425548) |
| [Technical Architecture HLD v0.71](https://github.com/judgeprotocol/protocol/blob/main/judge_protocol_hld_v0_71.pdf) | Hardware and software architecture — HACK chip, COE, ACP, three-layer stack, phased implementation | [10.5281/zenodo.20460110](https://doi.org/10.5281/zenodo.20460110) |
...
| [Master Deck](https://github.com/judgeprotocol/protocol/blob/main/judge_protocol_master_deck_090926a.pdf) | Presentation deck — covering the full framework for briefings and outreach | — |
